...
/** INTERNAL snake_case body of one `GET /api/v1/payment_methods` record. */
...
/** INTERNAL body of a paginated `GET /api/v1/payment_methods?status=active` response. */
...
/** INTERNAL snake_case body of `GET /api/v1/safetypay/banks/{apiKey}/`. */
...
/** EXACT body of `POST /api/v1/process/` for a one-shot payment. */
